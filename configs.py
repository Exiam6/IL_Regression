...
def get_args():
    ...
    parser.add_argument('--save_dir', type=str, default="/scratch/zz4330/IL_Regression_2D_V2/Result_New/Case1_W5e-3/", help='Directory to save results')
    parser.add_argument('--lambda_W', type=float, default=5e-1, help='Regularization lambda W')
    parser.add_argument('--pca_n', type=int, default=2, help='Dimension of pca components')
    parser.add_argument('--case2', type=int, default=0, help='Enable case 2 scenario')
    parser.add_argument('--bias', default=True, action='store_true', help='Enable bias scenario')
    ...
    parser.add_argument('--lambda_H', type=float, default=1e-1, help='Regularization lambda H')
